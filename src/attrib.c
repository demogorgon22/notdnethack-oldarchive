...
const struct innate {
	...
	mon_abil[] = { {   1, &(HFast), "", "" },
		     {   1, &(HSleep_resistance), "", "" },
		     {   1, &(HSee_invisible), "", "" },
		     {   2, &(HNo_prop), "able to punch more defensively", "unable to punch more defensively" },
		     {   3, &(HPoison_resistance), "healthy", "sickly" },
		     {   4, &(HNo_prop), "able to punch more forcefully", "unable to punch more forcefully" },
		     {   5, &(HStealth), "stealthy", "noisy" },
		     {   6, &(HNo_prop), "able to meditate", "unable to meditate" },
		     {   7, &(HWarning), "sensitive", "insensitive" },
		     {   8, &(HNo_prop), "able to punch more nimbly", "unable to punch more nimbly" },
		     {   9, &(HSearching), "perceptive", "unaware" },
		     {  10, &(HNo_prop), "able to punch more ethereally", "unable to punch more ethereally" },
