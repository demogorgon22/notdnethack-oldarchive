...
{	{"Anachrononaut", 0}, {
	...
	ART_ANNULUS,
	MA_HUMAN|MA_DWARF|MA_ELF|MA_VAMPIRE|MA_REPTILIAN|MA_CLOCK, ROLE_MALE|ROLE_FEMALE |
...
{	{"Convict", 0}, {
	...
	MA_HUMAN|MA_DWARF|MA_GNOME|MA_ORC|MA_ELF|MA_VAMPIRE|MA_DRAGON|MA_ANIMAL|MA_REPTILIAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  7,  7, 13,  6 },
	{  20, 20, 10, 20, 20, 10 },
