...
{	{"Archeologist", 0}, {
	...
	ART_ITLACHIAYAQUE,
	MA_MAGIC|MA_HUMAN|MA_DWARF|MA_GNOME|MA_CLOCK|MA_VAMPIRE|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
...
{	{"Anachrononaut", 0}, {
	...
	ART_ANNULUS,
	MA_DRAGON|MA_MAGIC|MA_HUMAN|MA_DWARF|MA_ELF|MA_VAMPIRE|MA_REPTILIAN|MA_CLOCK, ROLE_MALE|ROLE_FEMALE |
...
{	{"Barbarian", 0}, {
	...
	MA_ET|MA_HUMAN|MA_ORC|MA_VAMPIRE|MA_DRAGON|MA_REPTILIAN|MA_ETHEREAL, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  16,  7,  7, 15, 16,  6 },
	{  30,  6,  7, 20, 30,  7 },
...
{	{"Binder", 		 0}, {
	...
	ART_PEN_OF_THE_VOID,
	MA_ET|MA_MAGIC|MA_HUMAN|MA_DWARF|MA_GNOME|MA_ELF|MA_ORC|MA_CLOCK|MA_VAMPIRE|MA_DRAGON|MA_ANIMAL|MA_FEY|MA_REPTILIAN|MA_ETHEREAL, ROLE_MALE|ROLE_FEMALE |
...
{	{"Caveman", "Cavewoman"}, {
	...
	MA_REPTILIAN|MA_HUMAN|MA_DWARF|MA_GNOME|MA_DRAGON|MA_ANIMAL|MA_ETHEREAL, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  7,  7,  8,  6 },
	{  30,  6,  7, 20, 30,  7 },
...
{	{"Convict", 0}, {
	...
	MA_ET|MA_MAGIC|MA_HUMAN|MA_DWARF|MA_GNOME|MA_ORC|MA_ELF|MA_VAMPIRE|MA_DRAGON|MA_ANIMAL|MA_REPTILIAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  7,  7, 13,  6 },
	{  20, 20, 10, 20, 20, 10 },
...
{	{"Healer", 0}, {
	...
	MA_MAGIC|MA_HUMAN|MA_GNOME|MA_FEY|MA_ETHEREAL, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 13,  7, 11, 16 },
	{  15, 20, 20, 15, 25, 5 },
	/* Init   Lower  Higher */
...
{	{"Knight", 0}, {
	...
	MA_MAGIC|MA_DWARF|MA_HUMAN|MA_CLOCK|MA_DRAGON, ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  13,  7, 14,  8, 10, 17 },
	{  30, 15, 15, 10, 20, 10 },
	/* Init   Lower  Higher */
...
{	{"Mystic", 0}, {
	...
	MA_ET|MA_MAGIC|MA_HUMAN|MA_CLOCK|MA_DRAGON|MA_FEY|MA_ETHEREAL, ROLE_MALE|ROLE_FEMALE |
...
{	{"Nobleman", "Noblewoman"}, {
	...
	MA_ET|MA_MAGIC|MA_DWARF|MA_ELF|MA_HUMAN|MA_VAMPIRE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   10,10,  7, 10,  7,  7 },
	{  20, 18, 10, 20, 15, 17 },
...
{	{"Priest", "Priestess"}, {
	...
	MA_MAGIC|MA_HUMAN|MA_ELF|MA_CLOCK|MA_DRAGON|MA_ANIMAL|MA_REPTILIAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 10,  7,  7,  7 },
	{  15, 10, 30, 15, 20, 10 },
...
{	{"Pirate", 0}, {
	...
	MA_MAGIC|MA_HUMAN|MA_ELF, ROLE_MALE|ROLE_FEMALE |
...
{	{"Rogue", 0}, {
	...
	MA_ET|MA_MAGIC|MA_HUMAN|MA_ORC|MA_VAMPIRE|MA_ELF|MA_DRAGON|MA_ANIMAL|MA_REPTILIAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  7,  6 },
	{  20, 10, 10, 30, 20, 10 },
...
{	{"Ranger", 0}, {
	...
	MA_MAGIC|MA_HUMAN|MA_ELF|MA_GNOME|MA_ORC|MA_DRAGON|MA_ANIMAL|MA_REPTILIAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  13, 13, 13,  9, 13,  7 },
	{  30, 10, 10, 20, 20, 10 },
...
{	{"Tourist", 0}, {
	...
	MA_MAGIC|MA_HUMAN|MA_ETHEREAL, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  6,  7,  7, 10 },
	{  15, 10, 10, 15, 30, 20 },
	/* Init   Lower  Higher */
...
{	{"Troubadour", 0}, {
	...
	ART_LYRE_OF_ORPHEUS,
	MA_MAGIC|MA_HUMAN|MA_ELF|MA_GNOME|MA_ORC|MA_CLOCK|MA_DRAGON|MA_FEY, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  6, 10 },
	{  10, 10, 15, 25, 10, 30 },
...
{	{"Valkyrie", 0}, {
	...
	ART_ORB_OF_FATE,
	MA_MAGIC|MA_HUMAN|MA_DWARF|MA_FEY, ROLE_FEMALE | ROLE_LAWFUL|ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  12,  10, 12, 10, 10, 12 },
	{  18,  14, 16, 18, 20, 14 },
	/* Init   Lower  Higher */
...
{	{"Wizard", 0}, {
	...
	MA_MAGIC|MA_HUMAN|MA_ELF|MA_GNOME|MA_ORC|MA_VAMPIRE|MA_DRAGON|MA_REPTILIAN|MA_ETHEREAL, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  7,  7,  7,  7 },
	{  10, 30, 10, 20, 20, 10 },
...
{	"incantifier", "incantifier", "wanterkind", "Inc",
	...
	ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MA_MAGIC, 0, MA_GNOME|MA_ORC|MA_ELF,
	/*    Str     Int Wis Dex Con Cha */
	{      3,      3,  3,  3,  3,  3 },
	{ STR18(100), 18, 18, 18, 18, 18 },
	/* Init   Lower  Higher */
