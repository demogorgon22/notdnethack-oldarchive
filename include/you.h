...
struct u_event {
	...
	Bitfield(uhand_of_elbereth,7);	/* became Hand of Elbereth */
...
#define MATTK_TELEK 20
#define MATTK_CRAZE 21
#define MATTK_PULSE 22
#define MATTK_SYR 23
#define MATTK_VAMP 24
#define MATTK_BAT 25
...
#define BASE_ATTACK_BONUS	((Role_if(PM_ANACHRONOUNBINDER) || Role_if(PM_BARBARIAN) || Role_if(PM_CONVICT) || Role_if(PM_KNIGHT) || Role_if(PM_ANACHRONONAUT) || \
