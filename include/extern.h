...
E void FDECL(throwit, (struct obj *,long,BOOLEAN_P,int,int));
...
E struct obj * FDECL(make_corpse, (struct monst *));
...
E void FDECL(minstagoldify, (struct monst *,BOOLEAN_P));
...
E int FDECL(ready_weapon, (struct obj *));
E void FDECL(spearoff, (struct obj *));
